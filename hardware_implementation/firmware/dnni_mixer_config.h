...
#define SIZE_ACTIVATIONS 8192

static message_assignment_element_t message_assignment_elements_attention_input_attention_block_0[] = {{.id=1, .size=8196}, {.id=2, .size=8196}, {.id=3, .size=8196}, {.id=4, .size=8196}, };
static message_assignment_element_t message_assignment_elements_o_layer_attention_block_0[] = {{.id=1, .size=8196}, {.id=2, .size=8196}, {.id=3, .size=8196}, {.id=4, .size=8196}, };
static message_assignment_element_t message_assignment_elements_residual_block_0_0[] = {{.id=1, .size=8196}, {.id=2, .size=8196}, {.id=3, .size=8196}, {.id=4, .size=8196}, };
static message_assignment_element_t message_assignment_elements_residual_block_0_1[] = {{.id=1, .size=8196}, {.id=2, .size=8196}, {.id=3, .size=8196}, {.id=4, .size=8196}, };
...
#define MX_PAYLOAD_SIZE 200
#define MX_ROUND_LENGTH 695
#define MX_SLOT_LENGTH GPI_TICK_US_TO_HYBRID2(1310)
#define ROUND_LENGTH_MS            ((MX_ROUND_LENGTH*MX_SLOT_LENGTH / (GPI_HYBRID_CLOCK_RATE / 1000000)) / 1000 + 1000)
#define MX_GENERATION_SIZE 165
