...
arm_cmsis_nn_status arm_nn_vec_mat_mult_t_s8_in_f32_out(const int8_t *lhs,
                                                        const int8_t *rhs,
                                                        const int32_t *kernel_sum,
                                                        const int32_t *bias,
                                                        float *dst,
                                                        const int32_t lhs_offset,
                                                        const float dst_multiplier,
                                                        const int32_t rhs_cols,
                                                        const int32_t rhs_rows,
                                                        const int32_t address_offset,
                                                        const int32_t rhs_offset)
{
    if (rhs_offset)
    {
        ...
        for (int32_t i = 0; i < row_loop_cnt; i++)
        {
            ...
            *dst = acc_0 * dst_multiplier;
            *(dst + address_offset) = acc_1* dst_multiplier;
            dst += 2 * address_offset;
        }
...
arm_cmsis_nn_status arm_nn_vec_mat_mult_t_s8_f32_s8(const int8_t *lhs,
                                                        const int8_t *rhs,
                                                        const int32_t *kernel_sum,
                                                        const int32_t *bias,
                                                        int8_t *dst,
                                                        ...
                                                        const int32_t address_offset)
{
    ...
    for (int32_t i = 0; i < row_loop_cnt; i++)
    {
        ...
        acc_0 = (int32_t) roundf(acc_0 * dst_multiplier);
        acc_1 = (int32_t) roundf(acc_1 * dst_multiplier);
